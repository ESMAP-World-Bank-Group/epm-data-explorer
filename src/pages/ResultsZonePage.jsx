...
export default function ResultsZonePage() {
  ...
  const buildDispatch=()=>{
    ...
    if(dispMode==='full'&&seasons.length&&days.length){
      ...
      if(dem.some(v=>v!=null))datasets.push({label:'Demand',type:'line',data:dem,borderColor:'#8B0000',borderWidth:1,pointRadius:0,tension:0,fill:false,spanGaps:true,stack:'demand'});
    ...
    const demL=getDem();if(demL.some(v=>v))datasets2.push({label:'Demand',type:'line',data:demL,borderColor:'#8B0000',borderWidth:1,pointRadius:0,tension:0,fill:false,spanGaps:true,stack:'demand'});
